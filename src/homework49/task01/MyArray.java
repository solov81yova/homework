...
public class MyArray<E> implements Iterable<E> {
  ...
  public MyArray(E[] array) {
    // инициализируем массив-поле массивом такой же длины как и массив-параметр
  ...
  public void add(int index, E val) {
    ...
    if (index < 0 || index > array.length) {
      throw new IndexOutOfBoundsException("Index " + index + " is out of bounds for length "
          + array.length);
    }
  ...
  public void remove(int index) {
    ...
    if (index < 0 || index >= array.length) {
      throw new ArrayIndexOutOfBoundsException(
          "Array index " + index + " is out of bounds for length " + array.length);
    }
